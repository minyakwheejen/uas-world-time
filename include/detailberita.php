                    ...
                    <div class="col-lg-4">
                        ...
                        <div class="col-sm-12">
                          <div class="border-bottom pb-4 pt-4">
                            <div class="row">
                              <div class="col-sm-8">
                                <h5>
                                <a href= "https://worldtime.my.id/index.php?include=detail-berita&data=18" style="color:#000">JPU Hadirkan 9 Saksi di Sidang Ferdi Sambo dan Putri Candrawhati</a></h5>                                
                        ...
                        <div class="col-sm-12">
                          <div class="border-bottom pb-4 pt-4">
                            <div class="row">
                              <div class="col-sm-8">
                              <h5>
                                <a href= "https://worldtime.my.id/index.php?include=detail-berita&data=23" style="color:#000"> Vladimir Putin: Kami Tidak Gila, Tak Akan Gunakan Bom Nuklir Lebih Dulu</a></h5>                                
                                </h5>
                                <p class="fs-13 text-muted mb-0">
                                  <span class="mr-2">Photo </span>10 Minutes ago
                                </p>
                        ...
                        <div class="col-sm-12">
                          <div class="pt-4">
                            <div class="row">
                              <div class="col-sm-8">
                                <h5>
                                <a href= "https://worldtime.my.id/index.php?include=detail-berita&data=36" style="color:#000">Rupiah Hilang Tenaga, Bakal Sentuh Rp 16.000/US$ Kah?</a></h5>
                                </h5>
                                <p class="fs-13 text-muted mb-0">
                                  <span class="mr-2">Photo </span>10 Minutes ago
                                </p>
                      ...
                      <div class="trending">
                        ...
                        <div class="mb-4">
                          ...
                          <h3 class="mt-3 font-weight-600"><a href="http://localhost/world_time/index.php?include=detail-berita&data=49" style="color:#000">
                        ...
                        <div class="mb-4">
                          ...
                          <h3 class="mt-3 font-weight-600"><a href="http://localhost/world_time/index.php?include=detail-berita&data=50" style="color:#000">
