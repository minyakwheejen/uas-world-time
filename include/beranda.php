              ...
              <div class="col-xl-8">
                <div class="position-relative">
                  ...
                  <div class="banner-content">
                    ...
                    <h1 class="mb-2"><a href="https://worldtime.my.id/index.php?include=detail-berita&data=26">
              ...
              <div class="col-xl-4 stretch-card grid-margin">
                <div class="card bg-dark text-white">
                  <div class="card-body">
                    ...
                    >
                      <div class="pr-3">
                        <h5><a href="https://worldtime.my.id/index.php?include=detail-berita&data=18">JPU Hadirkan 9 Saksi di Sidang Ferdi Sambo dan Putri Candrawhati</a></h5>
                        <div class="fs-12">
                          <span class="mr-2">Photo </span>10 Minutes ago
                        </div>
                      </div>
                    ...
                    >
                      <div class="pr-3">
                        <h5><a href="https://worldtime.my.id/index.php?include=detail-berita&data=23"> Vladimir Putin: Kami Tidak Gila, Tak Akan Gunakan Bom Nuklir Lebih Dulu</a></h5>
                        <div class="fs-12">
                          <span class="mr-2">Photo </span>10 Minutes ago
                        </div>
                      </div>
                    ...
                    >
                      <div class="pr-3">
                        <h5><a href="https://worldtime.my.id/index.php?include=detail-berita&data=36">Rupiah Hilang Tenaga, Bakal Sentuh Rp 16.000/US$ Kah?</a></h5>
                        <div class="fs-12">
                          <span class="mr-2">Photo </span>10 Minutes ago
                        </div>
                      </div>
                  ...
                  <div class="card-body">
                    <div class="row">
                      ...
                      <div class="col-sm-8  grid-margin">
                        <h2 class="mb-2 font-weight-600" ><a href="https://worldtime.my.id/index.php?include=detail-berita&data=21" style="color:#000">
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-8">
                        <h2 class="mb-2 font-weight-600"><a href="https://worldtime.my.id/index.php?include=detail-berita&data=37" style="color:#000">
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-8">
                        <h2 class="mb-2 font-weight-600"><a href="https://worldtime.my.id/index.php?include=detail-berita&data=30" style="color:#000">
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-8">
                        <h2 class="mb-2 font-weight-600"><a href="https://worldtime.my.id/index.php?include=detail-berita&data=47" style="color:#000">
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-8">
                        <h2 class="mb-2 font-weight-600"><a href="http://localhost/world_time/index.php?include=detail-berita&data=43" style="color:#000">
